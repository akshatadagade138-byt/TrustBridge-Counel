import { Heart, Building2, Briefcase, ArrowUpRight } from "lucide-react";
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {GROUPS.map(({ title, icon: Icon, intro, points, eyebrow }, idx) => (
            <article
              ...
              className="group relative rounded-[28px] p-9 md:p-10 transition-all duration-500 hover:-translate-y-1 backdrop-blur-md"
              style={{
                background:
            ...
            >
              ...
              <h3 className="font-serif font-medium text-cream text-[28px] md:text-[32px] leading-tight mb-4">
                {title}
              </h3>
